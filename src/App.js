...
function SectionTitle({ label, title }) {
  return (
    <div style={{ marginBottom: 60 }}>
      <div style={{ color: "#00d4aa", fontSize: 12, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12, fontFamily: "'DM Mono', monospace" }}>
        — {label}
      </div>
      <h2 style={{ color: "#f1f5f9", fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 800, fontFamily: "'Syne', sans-serif", lineHeight: 1.1 }}>{title}</h2>
    </div>
  );
}
